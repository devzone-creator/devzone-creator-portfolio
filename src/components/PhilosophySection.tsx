...
const PhilosophySection = () => {
  return (
    <section className="py-16 bg-gradient-to-br from-gray-900 via-slate-900 to-cyan-900/20">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-8 text-white">My Philosophy</h2>
          <Card className="bg-gradient-to-r from-emerald-600 to-cyan-600 text-white border-0">
